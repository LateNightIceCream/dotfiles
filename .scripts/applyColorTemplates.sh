...
"$INJECTOR" ~/.config/dunst/dunstrc "$TEMPLATE_DIR/dunst/dunstrc.template" "$CONFIG_FILE"
...
# currently no built-in way of reloading dunst.
# https://github.com/dunst-project/dunst/issues/63
