#  ________  _________  ________  ________  ___       __   ________  ________
# |\   __  \|\___   ___\\   __  \|\   __  \|\  \     |\  \|\   ____\|\   __  \
# \ \  \|\  \|___ \  \_\ \  \|\ /\ \  \|\  \ \  \    \ \  \ \  \___|\ \  \|\  \
#  \ \  \\\  \   \ \  \ \ \   __  \ \   _  _\ \  \  __\ \  \ \_____  \ \   _  _\
#   \ \  \\\  \   \ \  \ \ \  \|\  \ \  \\  \\ \  \|\__\_\  \|____|\  \ \  \\  \|
#    \ \_____  \   \ \__\ \ \_______\ \__\\ _\\ \____________\____\_\  \ \__\\ _\
#     \|___| \__\   \|__|  \|_______|\|__|\|__|\|____________|\_________\|__|\|__|
#           \|__|                                            \|_________|
...
c.colors.completion.category.bg = fg_color
...
## Type: QtColor
c.colors.completion.category.fg = bg_color
...
## Type: QtColor
c.colors.completion.match.fg = accent_color
...
## the Qt default is used.
## Type: QssColor
c.colors.contextmenu.selected.fg = accent_fg
...
## Type: QtColor
c.colors.downloads.error.bg = warn_color
...
## Type: QtColor
c.colors.downloads.start.bg = getcolor('teal-4')

## Color gradient start for download text.
## Type: QtColor
c.colors.downloads.start.fg = bg_color

## Color gradient stop for download backgrounds.
## Type: QtColor
c.colors.downloads.stop.bg = accent_color

## Color gradient end for download text.
## Type: QtColor
c.colors.downloads.stop.fg = bg_color
...
## Type: QssColor
c.colors.keyhint.bg = accent_color

## Text color for the keyhint widget.
## Type: QssColor
c.colors.keyhint.fg = accent_fg

## Highlight color for keys to complete the current keychain.
## Type: QssColor
c.colors.keyhint.suffix.fg = accent2_color
...
## Type: QssColor
c.colors.messages.info.bg = accent_color

## Border color of an info message.
## Type: QssColor
c.colors.messages.info.border = accent_color

## Foreground color of an info message.
## Type: QssColor
c.colors.messages.info.fg = accent_fg
...
## Type: QssColor
c.colors.statusbar.caret.bg = getcolor('indigo-5')
...
## Type: QssColor
c.colors.statusbar.insert.bg = accent_color

## Foreground color of the statusbar in insert mode.
## Type: QssColor
c.colors.statusbar.insert.fg = accent_fg
...
## Type: QssColor
c.colors.statusbar.passthrough.bg = accent3_color

## Foreground color of the statusbar in passthrough mode.
## Type: QssColor
c.colors.statusbar.passthrough.fg = accent3_fg
...
## Type: QssColor
c.colors.statusbar.url.hover.fg = getcolor('blue-3')
...
## (https).
## Type: QssColor
c.colors.statusbar.url.success.https.fg = accent_color
...
## Type: QssColor
c.colors.tabs.bar.bg = getcolor("pink-6")
...
#c.colors.tabs.indicator.error = getcolor("red-7")

## Color gradient start for the tab indicator.
## Type: QtColor
#c.colors.tabs.indicator.start = getcolor()
...
## Type: Int
c.colors.webpage.darkmode.threshold.text = 127
...
c.content.user_stylesheets = ["~/.config/qutebrowser/css/userContent.css"]
